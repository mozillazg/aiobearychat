...
aiobearychat could always use more documentation, whether as part of the
official aiobearychat docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `aiobearychat` repo on GitHub.
...
3. The pull request should work for Python 3.5 and 3.6. Check
   https://travis-ci.org/mozillazg/aiobearychat/pull_requests
...
To run a subset of tests::
    ...
    $ py.test tests/test_aiobearychat.py
